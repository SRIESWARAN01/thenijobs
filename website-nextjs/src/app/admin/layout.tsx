...
import {
  ...
  BarChart3, CreditCard, Megaphone,
  Shield, Settings, Bell, LogOut, ChevronLeft,
  ChevronRight, Search, Menu, X, Star, TrendingUp,
  Globe, Zap, UserCheck, Package, ShoppingBag, UserCircle, Tag, MessageSquare,
} from 'lucide-react';
...
const ADMIN_NAV = [
  ...
  { label: 'Coupons', tamilLabel: 'தள்ளுபடி குறியீடுகள்', icon: Tag, href: '/admin/shop/coupons' },
          ...
          {collapsed ? (
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[10px] text-gray-500 truncate">{adminRole} - {adminEmail}</p>
              </div>
      ...
      <div className={`flex min-w-0 flex-1 flex-col transition-all duration-300 ${collapsed ? 'lg:ml-[72px]' : 'lg:ml-[280px]'}`}>
        ...
        <header className="sticky top-0 z-30 h-16 bg-[#0a0a1a]/80 backdrop-blur-xl border-b border-white/[0.06] flex items-center px-4 lg:px-6 gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            {/* Admin Avatar */}
            <Link href="/admin/settings" aria-label="Open admin settings" className="w-8 h-8 rounded-full bg-gradient-to-br from-violet-500 to-cyan-500 flex items-center justify-center hover:opacity-90 transition-opacity">
