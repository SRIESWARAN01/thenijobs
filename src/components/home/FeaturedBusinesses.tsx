...
const MOCK_BUSINESSES = [
  {
    id: '1',
    slug: 'arasu-pandi-farm-services-theni',
    name: 'Arasu Pandi Farm Services',
    ...
    isVerified: true,
    isPremium: true,
    tagline: 'Tractor rental, harvesting, land preparation',
    phone: '9876543210',
    whatsapp: '9876543210',
  },
  {
    id: '2',
    slug: 'theni-textiles-ltd',
    name: 'Theni Textiles Ltd',
    category: 'Textiles',
    location: 'Theni',
    rating: 4.6,
    reviews: 87,
    isVerified: true,
    isPremium: true,
    tagline: 'Garment manufacturing and export quality fabrics',
    phone: '9876543210',
    whatsapp: '9876543210',
  },
  {
    ...
    isVerified: true,
    isPremium: false,
    tagline: 'Web, app, SEO and digital marketing services',
    phone: '9876543210',
    whatsapp: '9876543210',
  },
  {
    id: '4',
    slug: 'greenfield-agro-theni',
    ...
    isVerified: true,
    isPremium: true,
    tagline: 'Seeds, fertilizers and farm consulting',
    phone: '9876543210',
    whatsapp: '9876543210',
  },
];
...
export default function FeaturedBusinesses() {
  ...
  const companiesList = dbCompanies && dbCompanies.length > 0
    ? dbCompanies.map((d: any) => ({
        id: d.id,
        slug: d.slug || d.id,
        name: d.name || '',
        ...
        whatsapp: d.whatsapp || d.phone || '9876543210',
      }))
    : MOCK_BUSINESSES;
                ...
                <article key={biz.id} className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm flex flex-col justify-between h-full">
                  ...
                  <div className="p-4 pt-0">
                    <div className="grid grid-cols-[1fr_42px_42px] gap-2">
                      ...
                      <a
                        href={`tel:${biz.phone}`}
                        className="flex min-h-11 items-center justify-center rounded-xl bg-teal-50 text-teal-800"
                        aria-label={`Call ${biz.name}`}
                      >
                        <Phone size={17} />
                      </a>
                      <a
                        href={`https://wa.me/91${biz.whatsapp}`}
                        className="flex min-h-11 items-center justify-center rounded-xl bg-emerald-50 text-emerald-800"
