      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <div className="glass-card rounded-2xl p-5">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <button onClick={handleToggleTwoFa} className={`w-11 h-6 rounded-full transition-colors ${twoFa ? 'bg-emerald-600' : 'bg-white/10'} relative`}>
              ...
              <div className="flex items-center justify-between">
                ...
                <select value={sessionTimeout} onChange={e => handleTimeoutChange(e.target.value)} className="bg-white/[0.06] border border-white/[0.1] rounded-lg px-3 py-1.5 text-sm text-white outline-none">
          ...
          <div className="glass-card rounded-2xl p-5">
            ...
            <p className="text-[10px] text-emerald-400 mb-3">✓ All Firestore models are active</p>
            <button className="w-full py-2.5 rounded-xl bg-cyan-500/10 text-cyan-400 text-sm font-semibold hover:bg-cyan-500/20 transition-colors">Verify Connection</button>
          </div>
        </div>
      </div>
