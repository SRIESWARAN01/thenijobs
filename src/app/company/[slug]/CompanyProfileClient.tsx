      ...
      <section className="pt-16">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="flex items-end gap-4 -mt-10 mb-6">
            {/* Logo */}
            <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl glass-card border-2 border-violet-500/30 flex items-center justify-center text-4xl sm:text-5xl shrink-0 shadow-2xl">
              🌾
            </div>
              ...
              {activeTab === 'gallery' && (
                <div className="glass-card rounded-2xl p-6">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {[...Array(6)].map((_, i) => (
                      <div key={i} className="aspect-square rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-4xl">
                        {['🌾', '🚜', '🏢', '👷', '🌿', '📊'][i]}
                      </div>
                    ))}
                  </div>
