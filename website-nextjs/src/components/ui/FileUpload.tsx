    ...
    <div className={className}>
      ...
      <AnimatePresence mode="wait">
        {!file ? (
          ...
          <motion.button
            ...
            onDrop={handleDrop}
            className={`relative w-full rounded-2xl border-2 border-dashed p-5 sm:p-8
              ...
              {isUploading ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-lg text-white/30 hover:text-white/60
      ...
      {error && (
        ...
        >
          ...
          <span className="min-w-0 text-xs text-rose-400">{error}</span>
        </motion.div>
      )}
    </div>
  );
