          ...
          <div className="px-3 pt-3">
            <div className="p-3 rounded-xl bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 border border-emerald-500/20">
              ...
              <div className="w-full h-1.5 bg-white/[0.06] rounded-full overflow-hidden">
                <div className="h-full bg-gradient-to-r from-emerald-500 to-cyan-500 rounded-full transition-all duration-500" style={{ width: '65%' }} />
              </div>
            </div>
          </div>
        )}
          ...
          {collapsed ? (
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[10px] text-emerald-400">🟢 Open to Work</p>
              </div>
