    ...
    <div className="min-h-screen bg-[#0a0a1a] flex items-center justify-center px-4 blob-bg grid-pattern">
      ...
      <div className="w-full max-w-sm">
        ...
        <Link href="/" className="flex items-center gap-2 justify-center mb-8">
          <Image src="/logo.png" alt="THENIJOBS Logo" width={160} height={40} className="h-10 w-auto object-contain" priority />
        </Link>
          ...
          {step === 'input' ? (
            ...
            <div className="space-y-6">
              ...
              <p className="text-center text-xs text-gray-500">
                Didn&apos;t receive? <button onClick={handleResendOtp} disabled={loading} className="text-violet-400 hover:text-violet-300 disabled:opacity-50">Resend OTP</button>
              </p>
            </div>
          )}
