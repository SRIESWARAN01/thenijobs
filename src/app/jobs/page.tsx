...
import {
  Search, MapPin, Filter, X, Briefcase, Clock, Banknote,
  Zap, Star, BookmarkPlus, ChevronDown, SlidersHorizontal,
  Building2, ArrowRight, BadgeCheck, Loader2
} from 'lucide-react';

import { collection, getDocs, query, where, orderBy, addDoc, writeBatch, serverTimestamp } from 'firebase/firestore';
...
const SALARY_RANGES = ['0–10k', '10k–20k', '20k–35k', '35k–60k', '60k+'];
                    ...
                    <div className="flex items-start justify-between gap-2 mb-1.5">
                      <div>
                        ...
                        <div className="flex items-center gap-1.5 mt-0.5">
                          <Link href={`/company/${job.id}`} className="text-sm text-gray-400 hover:text-violet-400 transition-colors">
                            {job.company}
                          </Link>
