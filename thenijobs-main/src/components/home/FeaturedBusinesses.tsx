      ...
      <div className="mx-auto max-w-6xl">
        ...
        {loading && dbCompanies.length === 0 ? (
                ...
                <article key={biz.id} className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm flex flex-col justify-between h-full">
                  ...
                  <div className="p-4 pt-0">
                    <div className="grid grid-cols-[1fr_42px_42px] gap-2">
                      ...
                      <a
                        href={biz.phone ? `tel:${biz.phone}` : undefined}
                      ...
                      <a
                        href={biz.whatsapp ? `https://wa.me/91${biz.whatsapp}` : undefined}
          ...
          <div className="rounded-2xl border border-dashed border-slate-300 bg-white p-10 text-center">
            <h3 className="font-outfit text-xl font-black text-slate-950">No featured businesses yet</h3>
            ...
            <Link
              ...
              className="mt-5 inline-flex items-center gap-2 rounded-xl bg-slate-950 px-4 py-2.5 text-sm font-black text-white hover:bg-teal-800"
            >
              Register business <ArrowRight size={15} />
            </Link>
          </div>
        )}
      </div>
